## To prepared the gene expression profiles of cells from CCLE
...
require(stringr)
require(NetBID2)
setwd("/Users/qpan/Desktop/HDAC6Manuscript/CodesAndData/DATA/CCLE")
...
draw.eset.QC(CCLE_RNASeq.log2TPM_geneLevel.all.eset, outdir = dir.qc, do.logtransform = FALSE, prefix = 'CCLE_RNASeq.log2TPM_geneLevel.all.',
...
draw.eset.QC(CCLE_RNASeq.log2TPM_geneLevel.breast.eset, outdir = dir.qc, do.logtransform = FALSE, prefix = 'CCLE_RNASeq.log2TPM_geneLevel.breast.',
             intgroup = NULL, choose_plot = c("heatmap", "pca", "density", "correlation", "meansd"), generate_html = TRUE, correlation_strategy = "pearson", plot_all_point = FALSE,
             emb_plot_type='2D.ellipse' # "2D", "2D.interactive", "2D.ellipse", "2D.text" or "3D" 
)